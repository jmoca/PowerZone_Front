...
function NotificationComponent_ng_container_6_ng_container_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "ion-row")(2, "ion-col")(3, "ion-item", 14)(4, "ion-avatar", 8);
    \u0275\u0275element(5, "img", 9);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "ion-label", 10)(7, "b");
    \u0275\u0275text(8);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("src", notification_r4.emitter.avatar, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(notification_r4.emitter.nickName);
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitch", notification_r4.type);
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitchCase", "MESSAGE");
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitchCase", "NEW_POST");
...
function NotificationComponent_ng_container_8_ng_container_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(5);
    \u0275\u0275property("src", notification_r6.emitter.avatar, \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(notification_r6.emitter.nickName);
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitch", notification_r6.type);
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitchCase", "MESSAGE");
    \u0275\u0275advance();
    \u0275\u0275property("ngSwitchCase", "NEW_POST");
...
_NotificationComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NotificationComponent, selectors: [["app-notification"]], decls: 9, vars: 4, consts: [["fullscreen", ""], [1, "ion-no-padding"], [1, "movil"], [1, "header"], [4, "ngIf"], [1, "section-header"], [4, "ngFor", "ngForOf"], ["lines", "none", 1, "notification-item", 3, "click"], ["slot", "start"], ["alt", "avatar", 3, "src"], [1, "notification-label"], [3, "ngSwitch"], [4, "ngSwitchCase"], [4, "ngSwitchDefault"], ["lines", "none", 1, "notification-item"]], template: function NotificationComponent_Template(rf, ctx) {
  if (rf & 1) {
...
//# sourceMappingURL=notification.component-5YH36SZL.js.map
